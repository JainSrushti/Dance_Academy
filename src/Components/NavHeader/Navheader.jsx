...
function Navheader() {
  ...
  return (
    <div>
      {/* ================= TOP BAR ================= */}
      <header className={`top ${scrolled ? "hide-top" : ""}`}>
        <div className="contact">
          <div className="tel">
            <a href="tel:+918446158862" target="_blank" rel="noopener noreferrer">
          ...
          <div className="mail">
            <a
              href="mailto:klassykurvesdanceacademy@gmail.com"
              target="_blank"
            ...
            >
              ...
              klassykurvesdanceacademy@gmail.com
            </a>
          </div>
        </div>
      ...
      {/* ================= NAVBAR ================= */}
      <div className={`navbar ${scrolled ? "navbar-fixed" : ""}`}>
        <div className="logo">
        ...
        <div className="navlinks">
          <div className="home">
            <a href="#">
              HOME
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512"> <path d="M140.3 376.8c12.6 10.2 31.1 9.5 42.8-2.2l128-128c9.2-9.2 11.9-22.9 6.9-34.9S301.4 192 288.5 192l-256 0c-12.9 0-24.6 7.8-29.6 19.8S.7 237.5 9.9 246.6l128 128 2.4 2.2z" /></svg>
            </a>
          </div>
        ...
        <div className="search-container">
             <button className="search-btn"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
              <path d="M480 272C480 317.9 465.1 360.3 440 394.7L566.6 521.4C579.1 533.9 579.1 554.2 566.6 566.7C554.1
               579.2 533.8 579.2 521.3 566.7L394.7 440C360.3 465.1 317.9 480 272 480C157.1 480 64 386.9 64 272C64 157.1 157.1 
               64 272 64C386.9 64 480 157.1 480 272zM272 416C351.5 416 416 351.5 416 272C416 192.5 351.5 128 272 128C192.5 128
                128 192.5 128 272C128 351.5 192.5 416 272 416z" /></svg> </button>
         </div>

        <div className="nav-button">
          <button>BOOK YOUR FREE TRIALS NOW !!</button>
        </div>
      </div>
    </div>
  );
